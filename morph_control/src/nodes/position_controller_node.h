...
#ifndef MORPH_CONTROL_LEE_POSITION_CONTROLLER_NODE_H
#define MORPH_CONTROL_LEE_POSITION_CONTROLLER_NODE_H
...
class PositionControllerNode {
 ...
 private:
  ...
  SMCPositionController smc_position_controller_;
...
#endif // MORPH_CONTROL_LEE_POSITION_CONTROLLER_NODE_H
